...
public class SaveAndLoadArea_1 : MonoBehaviour
{
	...
	public GameDataArea_1 data;
	private void Awake()
	{
		data = SaveManagerArea_1.Load();
		LoadGame();
	}
	...
	public void SaveGame()
	{
		...
		SaveManagerArea_1.Save(data);
		print("AREA_1 DATA SAVED");
	}
