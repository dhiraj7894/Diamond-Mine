...
public class SaveAndLoadArea_3 : MonoBehaviour
{
	...
	public GameDataArea_3 data;

	private void Awake()
	{
		data = SaveManagerArea_3.Load();
		LoadGame();
	}
	...
	public void SaveGame()
	{
		...
		SaveManagerArea_3.Save(data);
		print("AREA_3 DATA SAVED");
	}
